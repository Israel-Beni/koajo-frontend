    ...
    <section className="w-full bg-[image:linear-gradient(250deg,#000_1.2%,#032425_43.67%,#000_96.25%)]">
      <div className="page_container py-15 relative">
        ...
        <div className="flex flex-col gap-5 md:gap-6 items-center text-center mb-10 lg:mb-15 max-w-[calc(940rem/16)] mx-auto">
          ...
          See How We Are  <span className="text-highlight">Empowering Millions...</span>
          </h2>
        ...
        <div className="flex  lg:gap-28">
          ...
          <div className="relative flex flex-col gap-7.5 lg:gap-50 overflow-auto lg:h-[calc(677rem/16)] scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-transparent hover:scrollbar-thumb-gray-300">
            {/* Progress Bar */}
            <div className="absolute z-0 top-0 left-4.5 w-[1px] h-full bg-gray-100/25">
              <div className="bg-white h-[2%]" style={{ height: `${(activeIdx + 1) * 100 / steps.length}%` }} />
            </div>
